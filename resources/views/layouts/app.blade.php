...
<head>
    ...
    <title>@yield('title', 'BPO Job Listings')</title>
                        ...
                        @auth
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('applied-saved.index', ['tab' => 'applied']) }}">Job applications</a></li>
        ...
        <div class="container mb-3">
            ...
            <section class="col-md-3 col-12 d-flex flex-column mb-4" aria-labelledby="footer-about"  style="margin-top: -4%;">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <img src="{{ asset('asset/img/bpo_logo.png') }}" alt="BPO Bridge Logo" class="logo-footer mb-1" style="width: 130px; height: auto; margin-top: -5%;">
                    <h5 id="footer-about" class="mb-0" style="margin-top: -5%;" >About</h5>                    
                </div>
